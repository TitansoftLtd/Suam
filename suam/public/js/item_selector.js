...
async function add_multiple_items(frm) {
    // Freeze the UI
    frappe.dom.freeze();
    // Add custom loader to center of screen
    const loader = $(`
        <div id="custom-loader" style="
            ...
            text-align: center;
        ">
            <i class="fa fa-spinner fa-spin fa-5x" style="color: #007bff;"></i>
            <div style="margin-top: 12px; font-size: 20px; color: #555;">Loading items...</div>
        </div>
    `);
    $("body").append(loader);
