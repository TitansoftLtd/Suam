...
def execute(filters=None):
    ...
    columns = [
        ...
        {"fieldname": "custom_cu_invoice_number", "label": _("CU Invoice No."), "fieldtype": "Data", "width": 150},
        {"fieldname": "voucher_type", "label": _("Voucher Type"), "fieldtype": "Data", "width": 100},
    ...
    transactions = frappe.db.sql("""
        SELECT
            ...
            si.custom_cu_invoice_number AS custom_cu_invoice_number,
            gle.voucher_type,
            gle.debit,
            gle.credit,
            si.due_date,
    ...
    for txn in transactions:
        ...
        # Set dynamic link target
        txn["link_doctype"] = txn.get("voucher_type")
        if txn["link_doctype"] == "Invoice":
            txn["link_doctype"] = "Sales Invoice"
        elif txn["link_doctype"] == "Credit Note":
            txn["link_doctype"] = "Sales Invoice"
        elif txn["link_doctype"] == "Payment":
            txn["link_doctype"] = "Payment Entry"
